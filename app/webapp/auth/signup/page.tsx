    ...
    <div className="min-h-screen bg-black text-white flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-black mb-2 gradient-text">Create Account</h1>
          <p className="text-gray-400">Start recording and transcribing with AI</p>
        </div>
        ...
        <div className="glass rounded-3xl p-8">
          ...
          <p className="mt-6 text-center text-gray-400">
            ...
            <Link href="/webapp/auth/login" className="text-primary hover:text-purple-400">
              Sign in
            </Link>
          </p>
        </div>
