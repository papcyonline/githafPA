        ...
        <div className="flex gap-2 mb-6">
          <button
            ...
            className={`flex-1 py-2 rounded-lg transition-colors ${
              activeTab === 'checkin' ? 'bg-purple-500 text-white' : 'bg-white/5 text-gray-400'
            }`}
          >
            Today's Check-in
          </button>
          <button
            ...
            className={`flex-1 py-2 rounded-lg transition-colors ${
              activeTab === 'history' ? 'bg-purple-500 text-white' : 'bg-white/5 text-gray-400'
            }`}
          >
            History
          </button>
      ...
      <main className="max-w-2xl mx-auto px-4 pb-8">
        {activeTab === 'checkin' && (
          <div className="space-y-6">
            ...
            <div className="bg-white/5 rounded-xl p-6 border border-white/10 space-y-4">
              <div>
                <label className="block text-sm text-gray-400 mb-2">What are you grateful for? (comma separated)</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm text-gray-400 mb-2">Today's wins (comma separated)</label>
                <input
                  type="text"
                  value={formData.wins}
              ...
              <div>
                <label className="block text-sm text-gray-400 mb-2">Challenges (comma separated)</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm text-gray-400 mb-2">Tomorrow's priorities (comma separated)</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm text-gray-400 mb-2">Journal entry</label>
                <textarea
                  value={formData.journal_entry}
                  onChange={(e) => setFormData(d => ({ ...d, journal_entry: e.target.value }))}
                  className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 h-32"
        ...
        {activeTab === 'history' && (
          <div className="space-y-4">
            {history.map((checkin) => (
              <div key={checkin.id} className="bg-white/5 rounded-xl p-5 border border-white/10">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80">
          <div className="bg-gray-900 rounded-xl p-6 w-full max-w-md mx-4 border border-white/10">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-bold">Daily Check-in with AI</h2>
              <button
