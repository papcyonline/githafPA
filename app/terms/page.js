            ...
            <div className="glass rounded-3xl p-8 sm:p-12 space-y-8">
              <section className="space-y-4">
                ...
                <p className="text-gray-300 leading-relaxed">
                  By accessing and using PAssist AI ("the Service"), you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to these Terms of Service, please do not use the Service.
                </p>
              </section>
              ...
              <section className="space-y-4">
                ...
                <p className="text-gray-300 leading-relaxed">
                  PAssist AI provides an AI-powered meeting recording, transcription, and summarization service. The Service allows users to:
                </p>
              ...
              <section className="space-y-4">
                ...
                <p className="text-gray-300 leading-relaxed">
                  PAssist AI is not responsible for any illegal recording or use of the Service that violates applicable laws.
                </p>
              </section>
              ...
              <section className="space-y-4">
                ...
                <p className="text-gray-300 leading-relaxed">
                  You retain all rights to the content you create and upload to PAssist AI. By using the Service, you grant PAssist AI a limited license to process, store, and display your content solely for the purpose of providing the Service.
                </p>
                <p className="text-gray-300 leading-relaxed">
                  The PAssist AI platform, including its design, features, and technology, is protected by copyright, trademark, and other intellectual property laws. You may not copy, modify, distribute, or reverse engineer any part of the Service.
                </p>
              </section>
              ...
              <section className="space-y-4">
                ...
                <p className="text-gray-300 leading-relaxed">
                  PAssist AI uses artificial intelligence to transcribe and summarize recordings. While we strive for accuracy:
                </p>
                <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
                  <li>Transcriptions and summaries may contain errors</li>
                  <li>AI-generated content should be reviewed for accuracy</li>
                  <li>PAssist AI is not responsible for decisions made based on AI-generated content</li>
              ...
              <section className="space-y-4">
                ...
                <p className="text-gray-300 leading-relaxed">
                  You agree to indemnify and hold harmless PAssist AI, its officers, directors, employees, and agents from any claims, damages, losses, liabilities, and expenses (including legal fees) arising from:
                </p>
                <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
              ...
              <section className="space-y-4">
                ...
                <p className="text-gray-300 leading-relaxed">
                  These Terms shall be governed by and construed in accordance with the laws of the jurisdiction in which PAssist AI operates, without regard to its conflict of law provisions.
                </p>
              </section>
              ...
              <section className="space-y-4">
                ...
                <ul className="list-none text-gray-300 space-y-2 ml-4">
                  <li>Email: legal@passistai.app</li>
              ...
              <section className="space-y-4 pt-8 border-t border-white/10">
                <p className="text-gray-400 text-sm">
                  By using PAssist AI, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.
                </p>
              </section>
            </div>
          </div>
