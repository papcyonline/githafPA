      ...
      <section className="pt-32 sm:pt-40 pb-16 sm:pb-20 px-4 sm:px-6">
        <div className="container mx-auto max-w-5xl">
          ...
          <p className="text-base sm:text-lg text-gray-300 leading-relaxed mb-8 sm:mb-12">
            Find answers to common questions and learn how to get the most out of PAssist AI.
          </p>
              ...
              <div className="space-y-4">
                <details className="glass rounded-xl p-4 sm:p-5 cursor-pointer hover:bg-white/10 transition-all">
                  ...
                  <p className="mt-3 text-gray-300 text-sm sm:text-base">
                    Download the PAssist AI app from the App Store or Google Play, open it, and follow the sign-up process. You can sign up using your email address or social media accounts.
                  </p>
                </details>
                ...
                <details className="glass rounded-xl p-4 sm:p-5 cursor-pointer hover:bg-white/10 transition-all">
                  ...
                  <p className="mt-3 text-gray-300 text-sm sm:text-base">
                    No! PAssist AI supports unlimited recording length. Record as long as you need without worrying about time limits.
                  </p>
                </details>
              </div>
            </div>
            ...
            <div className="glass rounded-2xl sm:rounded-3xl p-6 sm:p-8">
              ...
              <div className="space-y-4">
                <details className="glass rounded-xl p-4 sm:p-5 cursor-pointer hover:bg-white/10 transition-all">
                  ...
                  <p className="mt-3 text-gray-300 text-sm sm:text-base">
                    PAssist AI uses advanced AI to provide highly accurate transcriptions. Accuracy improves with clear audio and minimal background noise. We support 12 languages with native speaker-level accuracy.
                  </p>
                </details>
                ...
                <details className="glass rounded-xl p-4 sm:p-5 cursor-pointer hover:bg-white/10 transition-all">
                  ...
                  <p className="mt-3 text-gray-300 text-sm sm:text-base">
                    PAssist AI can summarize your meetings, extract main points, generate to-do lists, and translate transcripts. More AI features are being added regularly.
                  </p>
                </details>
